...
const API_BASE_URL = 'http://localhost:5001/api/admin'; // Adjust if your backend runs elsewhere
const FILE_SERVER_BASE_URL = 'http://localhost:5001'; // Base URL for serving files from backend
